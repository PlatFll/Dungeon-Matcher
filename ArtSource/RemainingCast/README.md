...
and light/dark backgrounds. Open `Idles/*_Idle.aseprite` to edit the animations.
...
- `Recolored/`: 17 native stills and transparent PNGs. Each preserves its original
  alpha mask, scale, placement, face geometry, and prop silhouettes exactly.
...
Full helmets keep their original visors. The King and Minotaur use less compression
to retain weight. Capes, plumes and the banner tip have a small delayed response.
...
the seam is intentional. Some helmeted/heavy characters share an additional hold;
frame count is not a claim of nine unique drawings. All canvases remain **64×64**,
with unchanged foot pixels on row 63 and hard, binary transparency. Do not trim or
...
These check original-mask preservation, frame colors/alpha, connectivity, timing,
fixed soles, ready-pose return, unchanged sources, and exact native/PNG/GIF pixels.
